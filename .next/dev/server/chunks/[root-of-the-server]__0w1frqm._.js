...
async function GET(request) {
    try {
        ...
        const language = requestedLanguage || analysis.language;
        // -----------------------------------------
        ...
        const knowledgeItems = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Knowledge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            $or: searchConditions
        }).limit(50);
        // -----------------------------------------
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0w1frqm._.js.map